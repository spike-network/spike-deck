...
// Compact values use the same units and 1024-based scale as detailed labels.
export function formatCompactByteCount(bytes) {
  ...
  if (value >= 999.5) return ">999PB";
  return `${value.toFixed(unit && value < 99.95 ? 1 : 0)}${units[unit]}`;
}
