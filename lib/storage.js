...
const DEFAULT_INSTANCES = [
  {
    ...
    secret: '',
    httpProxy: '127.0.0.1:6152',
    socksProxy: '127.0.0.1:6153'
  }
];
...
export class StorageManager {
  ...
  /**
   * Get all instances.
   * @returns {Promise<Array<{id: string, name: string, baseUrl: string, secret?: string, httpProxy?: string, socksProxy?: string}>>}
   */
