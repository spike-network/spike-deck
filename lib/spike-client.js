...
export class SpikeApiClient {
  ...
  /**
   * Force-fetch every configured remote policy and ruleset provider, then
   * transactionally activate the validated runtime snapshot.
   */
  static async refreshProviders(instance) {
