 ...
 * Interacts with Spike Control REST API plus the /spike/* compatibility routes.
 */
...
export class SpikeApiClient {
  ...
  static async selectGroupMember(instance, groupName, memberName) {
    return await SpikeApiClient.request(instance, '/spike/policy_groups/select', {
      method: 'POST',
      body: { group_name: groupName, policy: memberName }
    });
  }
